...
/**
 * <a href="http://beefsalt.blog79.fc2.com/">主にAndroid</a>
 * <br/>
...
//		return view.getLeft() + view.getWidth() / 2;
	...
	private void onFinishedMovement() {
		...
		mOnScrollStopListener.onScrollStop(p);
		invalidate();
	}
...
//		sel.offsetLeftAndRight(selectedOffset);
	...
	/** TODO
	 * Callback invoked when the panel is scrolling.
	 * 
	 * @author 王成
	 * 
	 */
	public static interface OnScrollStopListener {
		/**
		 * Invoked when the panel start scroll.
		 */
